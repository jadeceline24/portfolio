  ...
  return (
    ...
    <div className="main">
      ...
      <div className="header-title">
        <h1 className='title'>FRONTEND<br/>WEB DEVELOPER</h1>
        <div className="moving-text">
          <span className='text'> - KUMUSTA - HELLO - Bonjour - Ciao - Olá - HALLO - Hallå - Guten tag - おい - KUMUSTA - HELLO - Bonjour - Ciao - Olá - HALLO - Hallå - Guten tag - おい - KUMUSTA - HELLO - Bonjour - Ciao - Olá - HALLO - Hallå - Guten tag - おい </span>
      ...
      <div className="header-text">
        <div className="text-left">
          <h2 className='info'>JADE CELINE TAPAWAN IS A FRONTEND WEB DEVELOPER BASED IN CAVITE, PHILIPPINES, WORKING WITH CLIENTS WORLDWIDE.</h2>
        </div>
        <div className="time">
        MY LOCAL TIME {mytime}<p>GMT (+8)</p>
